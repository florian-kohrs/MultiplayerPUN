...
public class GamePersistence
{
    ...
    public static Precomputation Precomputation
    {
        get
        {
            return GetInstance().precomputation;
        }
    }

    private Precomputation precomputation;
    ...
    private static GamePersistence GetInstance()
    {
        if (instance == null)
        {
    ...
    {
        currentGame.saveCurrentScene(GamePersistence.SaveType.Scene);
    }
        ...
        saveScene(List<ISaveableGameObject> ignoreForSave)
    {
        return currentGame.saveCurrentScene(
            GamePersistence.SaveType.Scene, ignoreForSave);
    }
    ...
    private bool SaveGame_(string saveName, out string resultMessage)
    {
        ...
        currentGame.saveCurrentScene(SaveType.Game);

        currentGame.SaveStaticValues();
